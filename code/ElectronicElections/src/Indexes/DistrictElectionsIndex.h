...
class DistrictElectionsIndex
{
	...
	void addElectionToDistrict(std::string district, char day, char month, short year, std::string charge);
	void removeElectionFromDistrict(std::string district, char day, char month, short year, std::string charge);
public:
